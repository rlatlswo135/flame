				...
				<table className="w-full text-sm">
					...
					<tbody>
						{props.map((prop) => (
							<tr
								key={prop.name}
								className="border-b border-flame-border last:border-b-0"
							>
								<td className="px-4 py-2.5 font-mono text-flame-accent text-xs">
									{prop.name}
								</td>
								...
								<td className="px-4 py-2.5 text-flame-text-secondary">
									{prop.description}
								</td>
							</tr>
						))}
