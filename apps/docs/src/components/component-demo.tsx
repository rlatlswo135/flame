		...
		<div className="rounded-xl border border-flame-border overflow-hidden">
			{title && (
				<div className="px-5 py-3 border-b border-flame-border">
					<h3 className="text-sm font-medium text-flame-text-secondary">
						{title}
					</h3>
				</div>
			)}
			<div className="p-8 bg-flame-bg-secondary flex items-center justify-center min-h-40">
				{children}
			</div>
				...
				{showCode && (
					<div className="relative border-t border-flame-border overflow-hidden">
						...
						<div
							...
							// biome-ignore lint/security/noDangerouslySetInnerHtml: codeHtml is build-time Shiki output, not user input
